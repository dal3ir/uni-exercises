...
const req_reprendre = function (req, res, query) {
   ...
   let marqueurs = {};
    ...
    contenu = fs.readFileSync("designGrille2.json", "utf-8");
    fichierGrille = JSON.parse(contenu);
    grille = fichierGrille[0];
    pacman = fichierGrille[1];
    pinky = fichierGrille[2];
    blinky = fichierGrille[3];
    clyde = fichierGrille[4];
    powerPallet = fichierGrille[5];
    counter = fichierGrille[6];
    ...
    fs.writeFileSync("grille2.json", contenu, "UTF-8");
